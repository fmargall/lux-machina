...
if __name__ == "__main__":
    ...
    # 0.(iv) Plenoptic Fibonacci sensor initialization
    sensorLF = Sensor3D()
    sensorLF.type = 2
    sensorLF.v0 = wp.vec3()    # Center
    sensorLF.v1 = wp.vec3()    # Normal (length is sensor's radius)
    sensorLF.i0 = wp.int32()   # Number of Fibonacci bins for spatial dimensions
    sensorLF.i1 = wp.int32()   # Number of Fibonacci bins for angular dimensions
    sensorLF.f0 = wp.float32() # Angular limit of directional representation
